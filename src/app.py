...
activities = {
    ...
    "Tennis Club": {
        "description": "Tennis coaching and recreational play",
    ...
    "Music Ensemble": {
        "description": "Orchestra and band rehearsals",
        "schedule": "Tuesdays, Thursdays, and Fridays, 3:00 PM - 4:00 PM",
        "max_participants": 25,
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["jason@mergington.edu", "rachel@mergington.edu"]
    }
}
